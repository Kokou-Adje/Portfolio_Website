    ...
    <footer className='bg-black-100 py-8'>
      <div className={`${styles.paddingX} max-w-7xl mx-auto flex flex-col items-center gap-6`}>
        ...
        <div className='flex gap-8'>
          {/* GitHub */}
          <a
            href='https://github.com/Kokou-Adje'
            target='_blank'
          ...
          {/* LinkedIn */}
          <a
            href='https://linkedin.com/in/kokou-adje'
            target='_blank'
            rel='noopener noreferrer'
            className='text-secondary hover:text-white transition-colors duration-300'
            title='LinkedIn'
          ...
          {/* Email */}
          <a
            href='mailto:kokou.maw.adje@gmail.com'
            className='text-secondary hover:text-white transition-colors duration-300'
            title='Email'
          >
            <svg
        ...
        {/* Divider */}
        <div className='w-full max-w-md h-[1px] bg-secondary/20' />

        {/* Copyright */}
        <p className='text-secondary text-[14px] text-center'>
          © {new Date().getFullYear()} Kokou Adje. All rights reserved.
        </p>
      </div>
    </footer>
  );
